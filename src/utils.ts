...
export type Transform = (data: any, context: TransformContext) => undefined | { data: any, ignoreKeys: IgnoreKeys }

export function isObject(value: any): value is { [key: string]: any } {
  return typeof value === 'object' && value !== null
}

export const runTransforms = (data: any, transforms: Transform[], parent: object | undefined, key: Key | undefined) => {
  let ignoreKeys: Key[] = []
